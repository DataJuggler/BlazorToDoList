...
namespace ApplicationLogicComponent.DataOperations
{
    ...
    public class DataOperationsManager
    {
        ...
        private ToDoMethods todoMethods;
        #endregion
        ...
        #region Methods
            ...
            private void Init()
            {
                ...
                this.ToDoMethods = new ToDoMethods(this.DataManager);
            }
            #endregion
        ...
        #region Properties
            ...
            #region ToDoMethods
            public ToDoMethods ToDoMethods
            {
                get { return todoMethods; }
                set { todoMethods = value; }
            }
            #endregion
